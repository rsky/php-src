...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_LOGICAL_NOT", T_LOGICAL_NOT, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_UNLESS", T_UNLESS, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_UNTIL", T_UNTIL, CONST_CS | CONST_PERSISTENT);
